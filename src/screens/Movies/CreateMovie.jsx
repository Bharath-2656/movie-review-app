...
const CreateMovie = () => {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    if (!movie.releaseYear || isNaN(movie.releaseYear) || movie.releaseYear < 1900 || movie.releaseYear > 2025) {
      validationErrors.releaseYear = 'Release Year must be a number between 1900 and 2025';
    }
  ...
  return (
    <div className="create-movie-container">
      ...
      <h2 className="create-movie-title">{movieId ? 'Edit Movie' : 'Create Movie'}</h2>
